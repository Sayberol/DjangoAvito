...
from ads.serializers import AdSerializer, AdDetailSerializer, SelectionListSerializer, SelectionDetailSerializer
...
class AdView(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.GET.get("price_from", None):
            self.object_list = self.object_list.filter(name__gte=request.GET.get('price_from'))

        if request.GET.get("price_to", None):
            self.object_list = self.object_list.filter(name__lte=request.GET.get('price_to'))
