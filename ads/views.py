...
class Addinfo(View):
    def get(self, request):
        data_ads = pandas.read_csv("/Users/saybe/PycharmProjects/djangoProject1/database/ads.csv", sep=",").to_dict()
...
class AddInfoCat(View):
    def get(self, request):
        data_ads = pandas.read_csv("/Users/saybe/PycharmProjects/djangoProject1/database/categories.csv", sep=",").to_dict()
